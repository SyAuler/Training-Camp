...
public class FormProdutora extends javax.swing.JDialog {

    DAOProdutora dao = new DAOProdutora();
    ...
    public FormProdutora(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        listObjetos = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<model.ModelProdutora>())
        ;
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        listObjetos.add((ModelProdutora) new ModelProdutora());
        int linha = listObjetos.size() - 1;
        tblObjetos.setRowSelectionInterval(linha, linha);
        trataEdicao(true);
        txtNome.requestFocus();
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if (validaCampos()) {
            ...
            ModelProdutora obj = listObjetos.get(linhaSelecionada);
            dao.salvar(obj);
            trataEdicao(false);
            atualizaTabela();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormProdutora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormProdutora dialog = new FormProdutora(new javax.swing.JFrame(), true);
    ...
    private java.util.List<model.ModelProdutora> listObjetos;
