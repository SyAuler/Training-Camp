...
public class FormCidade extends javax.swing.JDialog {
    ...
    public void atualizaTabela() {
        listObjetos.clear();
        listObjetos.addAll(daoCidade.getLista());
    ...
    private void initComponents() {
        ...
        listObjetos = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<ModelCidade>())
        ;
        ...
        abaDados.setMinimumSize(null);
        abaDados.setPreferredSize(new java.awt.Dimension(0, 0));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblObjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.cidade}"), txtNome, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        cbxUf.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
                ...
                .addGroup(abaDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(abaDadosLayout.createSequentialGroup()
                        ...
                        .addGroup(abaDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cbxUf, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        listObjetos.add((ModelCidade) new ModelCidade());
        int linha = listObjetos.size() - 1;
        tblObjetos.setRowSelectionInterval(linha, linha);
        trataEdicao(true);
        txtNome.requestFocus();
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (validaCampos()) {
            ...
            ModelCidade obj = listObjetos.get(linhaSelecionada);
    ...
    private java.util.List<ModelCidade> listObjetos;
