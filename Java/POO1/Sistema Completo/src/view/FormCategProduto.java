...
public class FormCategProduto extends javax.swing.JDialog {

    DAOCategProduto daoCategProduto = new DAOCategProduto();

    public void atualizaTabela() {
        listObjetos.clear();
        listObjetos.addAll(daoCategProduto.getLista());
    ...
    public FormCategProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        listObjetos = org.jdesktop.observablecollections.ObservableCollections.observableList(new ArrayList<ModelCategProduto>())
        ;
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        listObjetos.add((ModelCategProduto) new ModelCategProduto());
        int linha = listObjetos.size() - 1;
        tblObjetos.setRowSelectionInterval(linha, linha);
        trataEdicao(true);
        txtNome.requestFocus();
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (validaCampos()) {
            ...
            ModelCategProduto obj = listObjetos.get(linhaSelecionada);
            daoCategProduto.salvar(obj);
            trataEdicao(false);
            atualizaTabela();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCategProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormCategProduto dialog = new FormCategProduto(new javax.swing.JFrame(), true);
    ...
    private java.util.List<ModelCategProduto> listObjetos;
