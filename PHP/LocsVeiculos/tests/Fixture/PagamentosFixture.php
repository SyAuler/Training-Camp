...
class PagamentosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'dataPagamento' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'valor' => 1,
                'dataPagamento' => '2019-07-14',
                'loc_id' => 1,
                'cliente_id' => 1,
                'funcionario_id' => 1,
                'created' => '2019-07-14 17:40:48',
                'modified' => '2019-07-14 17:40:48'
            ],
        ];
        parent::init();
    }
