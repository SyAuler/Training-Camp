...
class PaisesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'pais' => ['type' => 'string', 'length' => 220, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'cidade_id' => 1,
                'created' => '2019-07-14 17:40:53',
                'modified' => '2019-07-14 17:40:53'
            ],
        ];
        parent::init();
    }
