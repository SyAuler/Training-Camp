...
class FuncionariosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'loc_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'loja_id' => 1,
                'loc_id' => 1,
                'created' => '2019-07-14 17:40:18',
                'modified' => '2019-07-14 17:40:18'
            ],
        ];
        parent::init();
    }
